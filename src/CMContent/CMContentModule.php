  ...
  public function Manage($action=null) {
    switch($action) {
      ...
      case 'sample': 
        ...
        $this->db->ExecuteQuery(self::SQL('insert content'), array('markdown', 'page', 'Page with Markdown', "This is a demo of the markdown filter.\n\n* list\n* list\n", null, 'markdown', $this->user['id']));
        $this->db->ExecuteQuery(self::SQL('insert content'), array('file', 'page', 'Page from file', "This page includes data from a file.", 'hello_world/hello.txt', 'markdown', $this->user['id']));
