...
<header class='ly-blog-header'>
  ...
  <h1><?=t('Author: @name', array('@name' => $author['name']))?></h1>
  <p><?=t('Here are the pages, posts and articles that has @name (@email) as author.', array('@name' => $author['name'], '@email' => $author['email']))?></p>
